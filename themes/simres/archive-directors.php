      ...
      <div class="directors">
        ...
        <div class="director-photo">
          <a class="lightbox" href="#<?php echo the_id(); ?>">
            <img src="<?php echo esc_html( CFS()->get('primary_photo') ); ?>" alt="<?php esc_attr( the_title() ); ?>" />
          </a>
          <div class="lightbox-target" id="<?php echo the_id(); ?>">
            <img src="<?php echo esc_html( CFS()->get('secondary_photo') ); ?>" alt="<?php esc_attr( the_title() ); ?>" />
            <div class="caption">
              <?php the_title('<h2>', '</h2>') ?>
              <?php the_content(); ?>
            </div>
